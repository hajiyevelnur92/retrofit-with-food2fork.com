...
public class Ingredient {
    ...
    public Ingredient(String publisher, String f2f_url, String[] ingredients , String source_url, String recipe_id, String image_url, Float social_rank, String publisher_url, String title) {
